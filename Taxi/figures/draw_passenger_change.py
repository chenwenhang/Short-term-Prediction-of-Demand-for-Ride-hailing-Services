...
trips_period = trips_period.groupby(['TimePeriod'])['passenger_count'].mean().reset_index()
...
plt.scatter(x, y, s=5)
plt.title("Passenger Count Change", fontsize=22)
plt.xlabel("TimePeriod", fontsize=12)
plt.ylabel("Passenger Count", fontsize=22)
